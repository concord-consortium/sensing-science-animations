...
return}throw "Unable to print message: " + String(a)}}],["","file:///C:/Users/qxie/git/sensing-science-animations/web/screen5.dart",,Y,{
"^":"",
Iq:[function(){var z=J.S6($.xs())
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new Y.em()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","eE",0,0,0],
em:{
"^":"Tp:7;",
call$1:function(a){J.IR($.xs().style,"hidden")
J.IR($.SL().style,"visible")
J.Up($.Wp())
return}}},1],])
...
I.$lazy($,"runButton","Xc","Wp",function(){return document.querySelector("#run_button")})
I.$lazy($,"video","Km","xs",function(){return document.querySelector("#video-5")})
I.$lazy($,"appletWindow","RJ","SL",function(){return document.querySelector("#applet_window")})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
